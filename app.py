...
# 5. بيانات المذاهب (مُحدثة بإضافة المذهب الزيدي)
MADHABS_DATA = {
    "مالكي": {
...
# 6. قائمة الدول المحدثة بكافة الدول المطلوبة
COUNTRIES = [
    ...
    {"flag": "🇦ف", "name": "أفغانستان", "madhab": "حنفي", "pop": "نحو 44 مليون"},
